...
function getSearchApi(botResponse, partToCheck) {
  if (urlToCheck === '') {
    say(botResponse, 'Пожалуйста введите номер запчасти');
    return;
  }

  say(botResponse, 'Подожидите пожалуйста, проверяю наличие на складе');
